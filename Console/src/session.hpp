...
class session : public QObject
{
  ...
  public:
    explicit session(asio::ip::tcp::socket socket, tsqueue<message>& incoming, QObject *parent=nullptr,std::function<void(bool)> signal=nullptr); //, const QObject* parent,const char* signal
    ~session();
     ...
     */
    bool inline valid() { return m_status; }
